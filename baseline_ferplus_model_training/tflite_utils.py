# baseline_ferplus_model_training/tflite_utils.py
...
def get_tflite_model_predictions(tflite_model_path, image_data):
    ...
    y_pred = np.zeros(len(image_data), dtype=np.int32)  # Changed from np.int to np.int32
    ...
    for i in range(len(image_data)):
        ...
        y_pred[i] = prediction[0]  # Added [0] to get scalar from array
