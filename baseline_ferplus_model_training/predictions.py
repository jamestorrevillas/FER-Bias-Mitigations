# baseline_ferplus_model_training/predictions.py
...
def plot_training_history(history, save_dir=None):
    ...
    Args:
        ...
        save_dir(string): directory to save the plot to (optional)
...
def plot_confusion_matrix(confusion_matrix, class_names, save_dir=None):
