# baseline_ferplus_model_training/data/data.py
...
def get_data_pipeline(dataset_df,
    ...
    # Add info about whether augmented data is being used
    if hasattr(params, 'use_augmented_data') and params.use_augmented_data:
        print(f"Using data pipeline with augmented data. Total samples: {len(images)}")
    else:
        print(f"Number of samples in pipeline: {len(images)}")
