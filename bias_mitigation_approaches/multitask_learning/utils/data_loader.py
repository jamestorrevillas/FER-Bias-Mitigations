# bias_mitigation_approaches/multitask_learning/utils/data_loader.py
...
def prepare_multitask_data(images, emotion_labels, gender_labels, age_labels):
    """
...
def generate_balanced_batches(images, emotion_labels, gender_labels, age_labels, batch_size=BATCH_SIZE):
    ...
    x, [y_emotion, y_gender, y_age] = prepare_multitask_data(
